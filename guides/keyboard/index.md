...
Start by pushing the sockets into the top side PCB (the opposite where you soldered the hotswaps sockets and the diodes). With the sockets still in place, flip the PCB over onto a flat surface.
